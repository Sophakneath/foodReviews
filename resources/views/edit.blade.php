...
<div class="container">
    ...
    <div class="alert alert-danger" role="alert">
        <h4 class="alert-heading">There are one or more issues with the following post!
            <button type="button" class="close">
                <span aria-hidden="true"><img src="{{ asset('/img/icons/error.png')}}" width="30px"></span>
            </button>
        </h4>
        <p>{{$d->reason}}</p>
        <hr>
        <strong>Thank You For Your Review!</strong> We would love it if you make some changes according to the mentioned issue(s) above and resubmit!
    </div>
            ...
            <div class="card cardview">
                <div class="row">
                    <div class="col-lg-12" style="padding:80px">
                        <h3 class="type title" style="font-size:28px"> <b>EDIT YOUR REVIEW?</b></h3>   
                        <br><br>
                        <form method="post" action="{{ url('/api/myaccount/reupload')}}" enctype="multipart/form-data">
